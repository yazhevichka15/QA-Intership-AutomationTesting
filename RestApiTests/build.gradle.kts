...
val openApiGenerateFrontend by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    generatorName.set("java")
...
tasks.register<GradleBuild>("cleanBuildPublish") {
    tasks = listOf("openApiGenerateAdmin", "openApiGenerateFrontend")
}
